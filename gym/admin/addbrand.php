...
if (isset($_POST["addbrand"])) {
    ...
    if (empty($brandname) || empty($mota)) {
        echo "Error: All fields are required.";
    } else {
        $flag = $region->addbrand($conn, $brandname, $mota);
        if (!$flag) {
...
if (isset($_GET["action"]) && ($_GET["action"] == "delete")) {
    $flag = $region->deletebrand($conn, $_GET["brandName"]);
    if (!$flag) {
        echo "Error: insert incorrect!!!";
    }
...
if (isset($_GET["action"]) && ($_GET["action"] == "update")) {
    $regionupdate = $region->findBrandID($conn, $_GET["brandID"]);
    if (isset($_POST['updatebrand'])) {
        $region->updateBrand($conn,$_POST['brandName'], $_POST['mota'],$_GET['brandID']);
        header("location:addbrand.php");
    }
}
?>
                    ...
                    <table border="0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" name="brandName" value='<?php
                                    if (isset($_GET["action"]) && ($_GET["action"] == "update")) {
                                        echo $regionupdate["brandName"];
                                    }
                                    ?>' /></td>
                            </tr>
                            <tr>
                    ...
                    <table border="1">
                        <thead>
                            <tr>
                                ...
                                <th width="40%">Mô tả thương hiệu</th>
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="?action=update&brandID=<?php echo $row["brandID"]; ?>"><img src="../assetss/img/app/icons8-update-50.png" width="30px" /></a>
                                    </td>
                                    <td>
                                        <a href="?action=delete&brandName=<?php echo $row["brandName"]; ?>"><img src="../assetss/img/app/icons8-delete-30.png" width="30px"/></a>
                                    </td>
                                </tr>
                                <?php
                            }
