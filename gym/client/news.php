                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single-latest-news">
                                         <a href="news_details.php?id=<?php echo $row["newsID"]; ?>"><img src="<?php echo '../assetss/img/news/' . $row["image"]; ?>" alt=""></a>

                                    <div class="news-text-box">
                                        <h3><a href="single-news.html"><?php echo $row['newsName']; ?></a></h3>
                                        <p class="blog-meta">
                                            <span class="author"><i class="fas fa-user"></i> Admin</span>
                                            <span class="date"><i class="fas fa-calendar"></i><?php echo $row['ngaythang']; ?></span>
                                        </p>
                                        <a href="news_details.php?id=<?php echo $row["newsID"]; ?>" class="read-more-btn">Chi tiết <i class="fas fa-angle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <?php
